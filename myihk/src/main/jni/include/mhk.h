...
#define LOG_TAG "HookDebug"
#define LOG_TAG2 "INLINEHOOK"
#define LEE(fmt, args...) __android_log_print(ANDROID_LOG_ERROR, LOG_TAG2, fmt, ##args);
#define LOGI(fmt, args...) __android_log_print(ANDROID_LOG_INFO, LOG_TAG, fmt, ##args);
#define LOGD(fmt, args...) __android_log_print(ANDROID_LOG_INFO, LOG_TAG2, fmt, ##args);
